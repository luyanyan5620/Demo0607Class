...
public class ExeclUtils {
    ...
    @DataProvider(name="execlDataProvider")
    public static Object[][] getDataProvider() throws IOException {
        return ExeclUtils.getTestData("/Users/yanyanl/Documents/Projects_Java/Demo0607Class/src/main/resources/", "data_del.xlsx", "delAddress");
    }

    public static Object[][] getTestData(String filePath, String fileName, String sheetName) throws IOException{
        File file = new File(filePath + "/" + fileName);
        //创建FileInpautStream对象用于读取Excel文件
        ...
        for (int i = 1; i<rowCount+1; i++){
            ...
            for (int j = 0; j<row.getLastCellNum();j++){
                ...
                if(j==0){
                    ...
                    fields[0] = cell0.getStringCellValue();
                }else {
